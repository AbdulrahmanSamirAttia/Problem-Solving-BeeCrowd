...
and print the message “Aluno aprovado.” (Approved student) in case of average 5.0 or more or "Aluno reprovado."
(Reproved student) in case of average 4.9 or less.
...
if average >= 7.0:
    ...
    print(f"Media final: {(average + score) / 2 :.1f}")
